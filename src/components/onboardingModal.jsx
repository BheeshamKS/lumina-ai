...
const PROVIDERS = [
  {
    ...
    icon: (
      <svg viewBox="0 0 24 24" className="w-6 h-6" fill="none">
        ...
        <path
          d="M21.54 8.5C20.37 5.17 17.46 2.67 13.9 2.1L12 12l9.54-3.5z"
          fill="#EA4335"
        />
      </svg>
    ),
...
export const OnboardingModal = ({ isOpen, onClose, onSaveKey }) => {
  ...
  const [step, setStep] = useState("welcome"); // "welcome" | "provider" | "success"
        ...
        {step === "welcome" && (
          <div className="p-7">
            ...
            <div className="mb-6">
              ...
              <h2
                className="text-2xl font-semibold text-card-text mb-2"
                style={{ fontFamily: "var(--font-sans)" }}
              >
              ...
              >
                Lumina routes your messages through your own API keys — your
                data stays private and you control the costs.
              </p>
            </div>
                ...
                >
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-start gap-3 flex-1 min-w-0">
                      <div className="mt-0.5 shrink-0 text-card-text">
                        {p.icon}
                      </div>
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2 flex-wrap mb-1">
                          <span
                            className="font-medium text-sm text-card-text"
                            style={{ fontFamily: "var(--font-sans)" }}
                          >
                            {p.name}
                          </span>
                          <span
                            className={`text-[10px] font-medium px-1.5 py-0.5 rounded-full ${p.badgeColor}`}
                          >
                            {p.badge}
                          </span>
                        </div>
                    ...
                    <ChevronRight
                      className="w-4 h-4 shrink-0 mt-1 opacity-40 group-hover:opacity-70 transition-opacity"
            ...
            >
              <div className="flex items-center justify-between gap-3">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p
                      className="font-medium text-sm text-card-text mb-0.5"
                      style={{ fontFamily: "var(--font-sans)" }}
                    >
                      Other providers
                    </p>
                    <p
                      ...
                      style={{ color: "var(--color-sidebar-text)" }}
                    >
                      OpenAI, Anthropic, Mistral, xAI, DeepSeek and more — set
                      up in Settings
                    </p>
                  </div>
                </div>
        ...
        {step === "provider" && provider && (
          <div className="p-7">
            ...
            <div className="flex items-center gap-3 mb-1">
              ...
              <h2
                className="text-xl font-semibold text-card-text"
                style={{ fontFamily: "var(--font-sans)" }}
              >
                {provider.name}
              </h2>
        ...
        {step === "success" && (
          <div className="p-7 flex flex-col items-center text-center">
            <div
              ...
              style={{ background: "var(--color-sidebar-ring)" }}
            >
              <Check className="w-7 h-7 text-white" />
            </div>
            <h2
              className="text-xl font-semibold text-card-text mb-2"
              style={{ fontFamily: "var(--font-sans)" }}
            >
              You're all set!
            </h2>
